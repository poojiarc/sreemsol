...
import { Link } from "react-router-dom";
import { ArrowRight } from "lucide-react";
import servicesHero from "@/assets/services.jpg"; // add your image here
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10">
            ...
            <div>
              ...
              <p className="text-primary-foreground/80 max-w-2xl text-lg">
                ...
                with innovation, efficiency, and scalable growth.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Deep knowledge across SAP, Salesforce, Workday, and cloud platforms.",
                },
                {
                  num: "02",
                  title: "Agile Delivery",
                  desc: "Flexible methodologies that adapt to your project needs and timelines.",
                },
                {
                  num: "03",
                  title: "Quality Assurance",
                  desc: "Rigorous testing and QA processes ensure flawless deliverables.",
                },
                {
                  num: "04",
                  title: "24/7 Support",
                  desc: "Dedicated post-project support to keep your systems running smoothly.",
                },
              ].map((item, i) => (
                <SectionReveal key={item.num} delay={i * 100}>
                  <div className="bg-card p-6 rounded-xl card-shadow h-full">
                    ...
                    <h3 className="font-heading font-semibold text-foreground mt-2 mb-2">
                      {item.title}
                    </h3>
      ...
      >
        <div className="container-custom px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            ...
            <p className="text-primary-foreground/80 mb-8 max-w-xl mx-auto">
              Contact us to discuss your specific requirements and let our experts
